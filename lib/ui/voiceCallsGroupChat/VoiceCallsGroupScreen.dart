...
import 'GroupVoiceCallsHandler.dart';
...
class _VoiceCallsGroupScreenState extends State<VoiceCallsGroupScreen> {
  ...
  _connect() async {
    _signaling = new GroupVoiceCallsHandler(
        ...
        case SignalingState.CallStateConnected:
          {
            if (mounted) {
              if (_signaling.timer == null) {
                ...
                _signaling.startCallDurationTimer((timer) {
                  setState(() {
                    _callDuration = updateTime(timer);
                  });
                });
              } else {
                if (!_signaling.timer.isActive) {
                  print(
              ...
              Padding(
                ...
                child: Text(
                  _isCallActive
                      ...
                      : widget.isCaller
                          ? 'Group voice calling ${widget.homeConversationModel.conversationModel.name}'
                          : '${widget.caller.fullName()} is group Voice '
